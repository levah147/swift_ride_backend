"""
Base settings for Swift Ride project.
"""
...
ROOT_URLCONF = 'swift_backend.urls'
...
WSGI_APPLICATION = 'swift_backend.wsgi.application'
ASGI_APPLICATION = 'swift_backend.asgi.application'
...
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'swift_backend/static')]
...
PHONENUMBER_DEFAULT_REGION = 'NG'  # Default to Nigeria
